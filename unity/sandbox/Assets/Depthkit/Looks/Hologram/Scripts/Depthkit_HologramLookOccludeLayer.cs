...
{
    /// <summary>
    /// HologramLookOccludeLayer adds a layer to render a transparency enabled DK clip projection.
    /// <summary>
    [System.Serializable]
    [DisallowMultipleComponent]
    public class Depthkit_HologramLookOccludeLayer : Depthkit_HologramLookLayer
    {
        ...
        {
            return "Depthkit/HologramOcclude";
        }
    }
}