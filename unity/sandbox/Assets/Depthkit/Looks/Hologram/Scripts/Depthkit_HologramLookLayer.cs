...
namespace Depthkit
{
    [ExecuteInEditMode]
    [System.Serializable]
    abstract public class Depthkit_HologramLookLayer : MonoBehaviour
    {
        ...
        [SerializeField]
        [HideInInspector]
        private Depthkit_HologramLook _parentRenderer;
        protected Depthkit_HologramLook ParentRenderer
        {
            get {
                if(_parentRenderer == null)
                {
                    _parentRenderer = GetComponent<Depthkit_HologramLook>();
                    if(_parentRenderer == null)
                    {
                        Debug.LogError("Hologram Render Layer added to component without Hologram Renderer.");
                    }
                }
        ...
        /// <summary>
        [SerializeField]
        private Depthkit_HologramLook.BlendMode _blendMode = Depthkit_HologramLook.BlendMode.Alpha;
        public Depthkit_HologramLook.BlendMode BlendMode
        {
